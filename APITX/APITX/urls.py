...
urlpatterns = [
    ...
    url(r'^duenio/bus/$', vistaBus.lista_objetos,{'var': 0}),
    url(r'^duenio/bus/activos/$', vistaBus.detalle_objetos,{'var': 0}),
    url(r'^duenio/bus/(?P<pk>[0-9]+)$', vistaBus.detalle_objetos,{'var': 1}),
